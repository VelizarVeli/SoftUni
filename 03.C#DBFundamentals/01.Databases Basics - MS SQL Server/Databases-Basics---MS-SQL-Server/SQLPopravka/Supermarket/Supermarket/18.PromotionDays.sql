CREATE FUNCTION udf_GetPromotedProducts(@CurrentDate DATETIME, @StartDate DATETIME,
 @EndDate DATETIME, @Discount Decimal(16,2), @FirstItemId INT, @SecondItemId INT, @ThirdItemId INT)
