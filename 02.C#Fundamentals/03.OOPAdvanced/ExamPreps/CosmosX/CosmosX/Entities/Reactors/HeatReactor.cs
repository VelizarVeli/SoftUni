...
namespace CosmosX.Entities.Reactors
{
    public class HeatReactor : BaseReactor
    {
        ...
        private int HeatReductionIndex { get; }
        
        public override long TotalEnergyOutput
        {
            get
            {
                if (base.TotalHeatAbsorbing < base.TotalEnergyOutput)
                {
                   return 0;
                }
        ...
        public override long TotalHeatAbsorbing => base.TotalHeatAbsorbing + this.HeatReductionIndex;
    }
}